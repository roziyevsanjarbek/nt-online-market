                    ...
                    <div class="flex flex-wrap mx-[-12px]">
                        <div class="min-[992px]:w-[50%] w-full px-[12px] mb-[24px]">
                            <div class="bb-bnr-details relative">
                                <div class="bb-image">
                                    <img src="assets/img/shop-bnr/one.jpg" alt="one" class="w-full rounded-[20px]">
                                </div>
                                <div class="overlay-bnr bg-[#00000080] h-full w-full absolute z-[0] top-[0] left-[0] rounded-[20px]"></div>
                                <div class="inner-contact w-full h-full p-[30px] absolute top-[0] right-[0] z-[1] flex flex-col justify-between items-end max-[480px]:p-[20px]">
                                    <h4 class="font-Poppins text-[38px] font-bold text-[#fff] leading-[1.2] tracking-[0.03rem] max-[480px]:text-[26px]">50%</h4>
                                    <p class="font-Poppins text-[28px] font-medium leading-[32px] text-right text-[#fff] tracking-[0.03rem] max-[480px]:text-[16px] max-[480px]:leading-[20px]">Fresh <br> Vegetable</p>
                                </div>
                            </div>
                        </div>
                        <div class="min-[992px]:w-[50%] w-full px-[12px] mb-[24px]">
                            <div class="bb-bnr-details relative">
                                <div class="bb-image">
                                    <img src="assets/img/shop-bnr/two.jpg" alt="two" class="w-full rounded-[20px]">
                                </div>
                                <div class="overlay-bnr bg-[#00000080] h-full w-full absolute z-[0] top-[0] left-[0] rounded-[20px]"></div>
                                <div class="inner-contact w-full h-full p-[30px] absolute top-[0] right-[0] z-[1] flex flex-col justify-between items-end max-[480px]:p-[20px]">
                                    <h4 class="font-Poppins text-[38px] font-bold text-[#fff] leading-[1.2] tracking-[0.03rem] max-[480px]:text-[26px]">30%</h4>
                                    <p class="font-Poppins text-[28px] font-medium leading-[32px] text-right text-[#fff] tracking-[0.03rem] max-[480px]:text-[16px] max-[480px]:leading-[20px]">Fresh & <br> Healthy Fruit</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-wrap w-full px-[12px]">
                        <ul class="bb-shop-tags w-full flex flex-wrap justify-center m-[-5px]">
                            <li class="active-tags m-[5px]">
                                <a href="javascript:void(0)" class="flex bg-[#fff] rounded-[15px] border-[1px] border-solid border-[#eee] py-[10px] px-[20px] transition-all duration-[0.3s] ease-in-out font-Poppins text-[15px] text-[#686e7d] font-light leading-[28px] tracking-[0.03rem] hover:text-[#6c7fd8] hover:border-[#6c7fd8]">Chocolates</a>
                            </li>
                            <li class="m-[5px]">
                                <a href="javascript:void(0)" class="flex bg-[#fff] rounded-[15px] border-[1px] border-solid border-[#eee] py-[10px] px-[20px] transition-all duration-[0.3s] ease-in-out font-Poppins text-[15px] text-[#686e7d] font-light leading-[28px] tracking-[0.03rem] hover:text-[#6c7fd8] hover:border-[#6c7fd8]">Vegetables</a>
                            </li>
                            <li class="m-[5px]">
                                <a href="javascript:void(0)" class="flex bg-[#fff] rounded-[15px] border-[1px] border-solid border-[#eee] py-[10px] px-[20px] transition-all duration-[0.3s] ease-in-out font-Poppins text-[15px] text-[#686e7d] font-light leading-[28px] tracking-[0.03rem] hover:text-[#6c7fd8] hover:border-[#6c7fd8]">Fruits</a>
                            </li>
                            <li class="m-[5px]">
                                <a href="javascript:void(0)" class="flex bg-[#fff] rounded-[15px] border-[1px] border-solid border-[#eee] py-[10px] px-[20px] transition-all duration-[0.3s] ease-in-out font-Poppins text-[15px] text-[#686e7d] font-light leading-[28px] tracking-[0.03rem] hover:text-[#6c7fd8] hover:border-[#6c7fd8]">Bakery</a>
                            </li>
                            <li class="m-[5px]">
                                <a href="javascript:void(0)" class="flex bg-[#fff] rounded-[15px] border-[1px] border-solid border-[#eee] py-[10px] px-[20px] transition-all duration-[0.3s] ease-in-out font-Poppins text-[15px] text-[#686e7d] font-light leading-[28px] tracking-[0.03rem] hover:text-[#6c7fd8] hover:border-[#6c7fd8]">Snakes</a>
                            </li>
                            <li class="m-[5px]">
                                <a href="javascript:void(0)" class="flex bg-[#fff] rounded-[15px] border-[1px] border-solid border-[#eee] py-[10px] px-[20px] transition-all duration-[0.3s] ease-in-out font-Poppins text-[15px] text-[#686e7d] font-light leading-[28px] tracking-[0.03rem] hover:text-[#6c7fd8] hover:border-[#6c7fd8]">Spices</a>
                            </li>
                            <li class="m-[5px]">
                                <a href="javascript:void(0)" class="flex bg-[#fff] rounded-[15px] border-[1px] border-solid border-[#eee] py-[10px] px-[20px] transition-all duration-[0.3s] ease-in-out font-Poppins text-[15px] text-[#686e7d] font-light leading-[28px] tracking-[0.03rem] hover:text-[#6c7fd8] hover:border-[#6c7fd8]">Cookies</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="min-[992px]:w-[75%] w-full px-[12px] mb-[24px]">
                    <div class="bb-shop-pro-inner">
                        <div class="flex flex-wrap mx-[-12px] mb-[-24px]">
                                    ...
                                    <div class="flex flex-wrap w-full">
                                        <div class="w-[50%] px-[12px] max-[420px]:w-full">
                                            <div class="bb-bl-btn py-[10px] flex max-[420px]:justify-center">
                                                <button type="button" class="grid-btn btn-grid-100 h-[38px] w-[38px] flex justify-center items-center border-[0] p-[5px] bg-transparent mr-[5px]" title="grid">
                                                    <i class="ri-apps-line text-[20px]"></i>
                                                </button>
                                                <button type="button" class="grid-btn btn-list-100 h-[38px] w-[38px] flex justify-center items-center border-[0] p-[5px] bg-transparent active" title="grid">
                            ...
                            <div class="min-[768px]:w-[33.33%] w-[50%] max-[480px]:w-full px-[12px] mb-[24px] width-100 pro-bb-content" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                            ...
                            <div class="min-[768px]:w-[33.33%] w-[50%] max-[480px]:w-full px-[12px] mb-[24px] width-100 pro-bb-content" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <span class="flags transition-all duration-[0.3s] ease-in-out absolute z-[5] top-[10px] left-[6px]">
                            ...
                            <div class="min-[768px]:w-[33.33%] w-[50%] max-[480px]:w-full px-[12px] mb-[24px] width-100 pro-bb-content" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <a href="javascript:void(0)">
                                            <div class="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
                            ...
                            <div class="min-[768px]:w-[33.33%] w-[50%] max-[480px]:w-full px-[12px] mb-[24px] width-100 pro-bb-content" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                                <div class="bb-pro-box bg-[#fff] border-[1px] border-solid border-[#eee] rounded-[20px]">
                                    <div class="bb-pro-img overflow-hidden relative border-b-[1px] border-solid border-[#eee] z-[4]">
                                        <span class="flags transition-all duration-[0.3s] ease-in-out absolute z-[5] top-[10px] left-[6px]">
