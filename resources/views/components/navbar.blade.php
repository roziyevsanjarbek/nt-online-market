                                        ...
                                        <li class="m-[0] flex items-center">
                                            @foreach($parentCategories as $parentCategory)
                                                ...
                                                @foreach($parentCategory->categories as $childCategory)
                                                    <li class="flex items-center leading-[28px]"><a href="shop-list-full-col-2.html" class="transition-all duration-[0.3s] ease-in-out font-Poppins py-[10px] leading-[22px] text-[14px] font-normal tracking-[0.03rem] text-[#686e7d] hover:text-[#6c7fd8] capitalize">{{ $childCategory->name }}</a></li>
                                                @endforeach
                                            </ul>
                                            @endforeach
                                        </li>
