            ...
            <div class="w-full px-[12px]">
                <div class="flex flex-wrap w-full bb-breadcrumb-inner m-[0] py-[20px] items-center">
                    <div class="min-[768px]:w-[50%] min-[576px]:w-full w-full px-[12px]">
                        <h2 class="bb-breadcrumb-title font-quicksand tracking-[0.03rem] leading-[1.2] text-[16px] font-bold text-[#3d4750] max-[767px]:text-center max-[767px]:mb-[10px]">Terms & Conditions</h2>
                    </div>
                    <div class="min-[768px]:w-[50%] min-[576px]:w-full w-full px-[12px]">
                        <ul class="bb-breadcrumb-list mx-[-5px] flex justify-end max-[767px]:justify-center">
                            ...
                            <li class="bb-breadcrumb-item font-Poppins text-[#686e7d] text-[14px] leading-[28px] font-normal tracking-[0.03rem] px-[5px] active">Terms & Conditions</li>
                        </ul>
                    </div>
                </div>
            </div>
...
<!-- Terms & Conditions -->
<section class="section-terms py-[50px] max-[1199px]:py-[35px]">
    <div class="flex flex-wrap justify-between relative items-center mx-auto min-[1400px]:max-w-[1320px] min-[1200px]:max-w-[1140px] min-[992px]:max-w-[960px] min-[768px]:max-w-[720px] min-[576px]:max-w-[540px]">
        <div class="flex flex-wrap w-full">
            <div class="w-full px-[12px]">
                <div class="section-title mb-[20px] pb-[20px] z-[5] relative flex flex-col items-center text-center max-[991px]:pb-[0]" data-aos="fade-up" data-aos-duration="1000"
                     data-aos-delay="200">
                    <div class="section-detail max-[991px]:mb-[12px]">
                        <h2 class="bb-title font-quicksand mb-[0] p-[0] text-[25px] font-bold text-[#3d4750] relative inline capitalize leading-[1] tracking-[0.03rem] max-[767px]:text-[23px]">Terms & <span class="text-[#6c7fd8]">Conditions</span></h2>
                        <p class="font-Poppins max-w-[400px] mt-[10px] text-[14px] text-[#686e7d] leading-[18px] font-light tracking-[0.03rem] max-[991px]:mx-[auto]">Customer Terms Conditions.</p>
                    </div>
                </div>
            </div>
            <div class="w-full">
                <div class="desc p-[30px] border-[1px] border-solid rounded-[20px]">
                    <div class="flex flex-wrap mx-[-12px] mb-[-24px]">
                        <div class="min-[992px]:w-[50%] w-full px-[12px] mb-[24px]">
                            <div class="terms-detail" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                                <div class="block mb-[24px]">
                                    <h3 class="font-quicksand tracking-[0.03rem] leading-[1.2] mb-[15px] text-[18px] font-bold text-[#3d4750]">Welcome to BlueBerry Store.</h3>
                                    <p class="font-Poppins text-[15px] font-normal leading-[28px] tracking-[0.03rem] text-[#686e7d]">Lorem psum is <b>simply dummy</b> text of the printing and typesetting industry. Lorem
                                ...
                                <div class="block mb-[24px]">
                                    <h3 class="font-quicksand tracking-[0.03rem] leading-[1.2] mb-[15px] text-[18px] font-bold text-[#3d4750]">BlueBerry Websites</h3>
                                    <p class="font-Poppins text-[15px] font-normal leading-[28px] tracking-[0.03rem] text-[#686e7d]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum is
                                ...
                                <div class="block mb-[24px]">
                                    <h3 class="font-quicksand tracking-[0.03rem] leading-[1.2] mb-[15px] text-[18px] font-bold text-[#3d4750]">How browsing and vendor works?</h3>
                                    <p class="font-Poppins text-[15px] font-normal leading-[28px] tracking-[0.03rem] text-[#686e7d]">Lorem Ipsum is simply dummy text of the printing <b>simply dummy</b> industry. Lorem Ipsum is
                                ...
                                <div class="block">
                                    <h3 class="font-quicksand tracking-[0.03rem] leading-[1.2] mb-[15px] text-[18px] font-bold text-[#3d4750]">Becoming an vendor</h3>
                                    <p class="font-Poppins text-[15px] font-normal leading-[28px] tracking-[0.03rem] text-[#686e7d]">Lorem Ipsum is simply dummy <b>simply dummy</b> printing and typesetting industry. Lorem Ipsum is
                                        simply dutmmy text ever since the 1500s, when an unknown printer took a galley of type
